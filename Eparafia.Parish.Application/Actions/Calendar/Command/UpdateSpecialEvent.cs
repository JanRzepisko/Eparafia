...
{
    public sealed record Command(Guid EventId, EventType? Type, string? Description, string? Name, DateTime? Date,
        int? Duration) : IRequest<Unit>;
    ...
    public class Handler : IRequestHandler<Command, Unit>
    {
        ...
        public async Task<Unit> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            if (specialEvent is null) throw new Exception("Special event not found");
